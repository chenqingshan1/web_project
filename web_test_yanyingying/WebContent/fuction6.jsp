...
//	System.out.println(date);
	...
	String url=null;
     try {  
    	 if (env.equals("kaifa")) {
    		 url = "http://192.168.1.166:28080/cache/del";  
             HttpClient client = new HttpClient();  
             PostMethod postMethod = new PostMethod(url);  
             postMethod.addParameter("key","daily_publish_job_count_"+key);
        
             responseCode = client.executeMethod(postMethod); 
 		} else if (env.equals("qa")) {
 			  url = "http://192.168.1.22:28080/cache/del";  
             HttpClient client = new HttpClient();  
             PostMethod postMethod = new PostMethod(url);  
             postMethod.addParameter("key","daily_publish_job_count_"+key);
             responseCode = client.executeMethod(postMethod); 
        ...
        //     String callBackString = postMethod.getResponseBodyAsString();  
         //    System.out.println("请求返回结果为:" + URLDecoder.decode(callBackString));  
        		request.setAttribute("module","page1");
